    ...
    try {
        ...
        if (produtosExistentes[0].total === 0) {
            ...
            await db.query(`
                ...
                ('Violão Acústico Yamaha', 'Cordas', 1500.00, 12, 'Violão clássico com cordas de nylon, ideal para iniciantes.', '/imagens/violao-yamaha.jpg'),
                ('Baixo Elétrico Tagima 4 Cordas', 'Cordas', 1800.00, 7, 'Baixo versátil com excelente captação ativa.', '/imagens/baixo.jpg'),
                ('Piano Digital Casio', 'Teclas', 4200.00, 4, 'Piano digital com 88 teclas sensitivas e pedal.', '/imagens/piano-casio.jpg'),
                ('Controladora DJ Pioneer', 'Áudio', 2500.00, 6, 'Controladora de 2 canais perfeita para mixagens.', '/imagens/controladora.jpg'),
                ...
                ('Bateria Eletrônica Roland', 'Percussão', 7800.00, 2, 'Bateria com pads de mesh head super realista.', '/imagens/bateria-eletronic.jpg'),
                ('Sintetizador Korg Minilogue', 'Teclas', 4500.00, 3, 'Sintetizador analógico polifônico de 4 vozes.', '/imagens/korg.jpg'),
